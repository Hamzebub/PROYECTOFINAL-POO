...
1."BD_pr_farmacia.sql" - contiene la creacion y tablas de la base de datos. El nombre de la base de datos se encuentra por defecto como "DB_ProyectoFM".  2."BD_FR_SP.sql" - contiene los store procedures necesarios para el funcionamiento correcto del sistema.  
