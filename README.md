...
En la ruta "src\Script" o "Farmacia\src\Script" se ubican 2 archivos con extension sql. Ejecutar en el siguiente orden:  1."BD_pr_farmacia.sql" - contiene la creacion y tablas de la base de datos. El nombre de la base de datos se encuentra por defecto como "DB_ProyectoFM".
